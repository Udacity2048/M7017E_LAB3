...
public class SIP implements SipListener {
    ...
    public SIP() {
        ...
        } catch (UnknownHostException | ParseException | TooManyListenersException | InvalidArgumentException | ObjectInUseException | PeerUnavailableException | TransportNotSupportedException e) {
                ...
                try {
                    if (transaction.getState() != TransactionState.COMPLETED) {
                        ...
                        if (clientAudioPort == -1) {
                            ...
                            call = new ProcessCall(caller, clientIP, clientAudioPort);
                            System.out.println("sdad");
